...
public class ItemData_ID_02 : MonoBehaviour
{

    public int itemID = 0;
    public string itemName = "回復藥";
    public string itemDescription = "市場上常見的回復藥，回復我方單體HP150點。";
    ...
    public int effectAmount_00 = 150;
