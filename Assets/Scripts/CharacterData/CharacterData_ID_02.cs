...
public class CharacterData_ID_02 : MonoBehaviour
{
    public static int characterID = 0;

    // 雙向紀錄角色在隊伍中的順序
    public static int teamNumber = 0;
    public string characterName = "Erudite";
    public int maxHp = 350;
    public int hp = 300;
    public int maxMp = 900;
    public int mp = 900;
