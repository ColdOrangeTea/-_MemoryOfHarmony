...
public class CharacterData_ID_05 : MonoBehaviour
{
    public static int characterID = 0;

    // 雙向紀錄角色在隊伍中的順序
    public static int teamNumber = 0;
    public string characterName = "Refectio";
    public int maxHp = 666;
    public int hp = 111;
    public int maxMp = 980;
    public int mp = 880;
